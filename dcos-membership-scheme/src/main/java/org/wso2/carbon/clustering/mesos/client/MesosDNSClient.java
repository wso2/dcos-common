...
public class MesosDNSClient {
    private static final Log log = LogFactory.getLog(MesosDNSClient.class);
    ...
    private static class MesosDNSHeadersInterceptor implements RequestInterceptor {
        @Override
    ...
    private static class MesosDNSErrorDecoder implements ErrorDecoder {
        @Override
